...
jQuery(document).ready(function(){
	...
	/*for(var i=1;i<=cuadros_portfolio;i++){
		jQuery('.view-display-id-block_resumen_portafolio_pequeno .views-row-'+i).hover(


		function() {
			jQuery('.view-display-id-block_resumen_portafolio_pequeno .views-row-'+i+ ' .hover-titulo').animate({top: "-272"}, 400,function() {});
			jQuery('.view-display-id-block_resumen_portafolio_pequeno .views-row-'+i+ ' .roll-over-portfolio').animate({top: "0"}, 400,function() {});


		},function() {
			jQuery('.view-display-id-block_resumen_portafolio_pequeno .views-row-'+i+ '.hover-titulo').animate({top: "0"}, 400,function() {});
			jQuery('.view-display-id-block_resumen_portafolio_pequeno .views-row-'+i+ '.roll-over-portfolio').animate({top: "273"}, 400,function() {});
